...
const tweetActions = (retweets: any, comments: any, likes: any) => {
...
const GrayText = ({children, numberOfLines, style}: { children: any, numberOfLines: any, style: any }) => {
    return (
...
const TweetContent = ({tweet}: { tweet: any }) => {
    const theme = useColorScheme();
    return (
